...
- `/dinnovos-security-scan revisa seguridad en <funcionalidad>`
- `/dinnovos-security-scan analiza vulnerabilidades en los servicios de <tema>`
- `/dinnovos-security-scan busca secrets en <módulo>`

**Sin argumentos:**
- `/dinnovos-security-scan` → escanea todo el proyecto
